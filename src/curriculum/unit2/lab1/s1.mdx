...
<div class='learn'><span style={{color: "green", backgroundColor: "#fcc7c2"}}>Directions for teacher: Either have your students read the text below independently, or go through it with them, providing a live demo of the iss-mimic page.</span></div>
<br />
